...
export { default as Tick } from "./components/victory-primitives/tick";
export { default as Needle } from "./components/victory-primitives/needle";
...
export { default as VictoryGauge } from "./components/victory-gauge";
