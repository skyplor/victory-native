...
import { VictoryContainer } from "sky-victory-core";

import { NativeHelpers, Portal } from "../index";

export default class extends VictoryContainer {
  constructor(props) {
    console.log("Inside victory-native container constructor");
    super(props);
  ...
  renderContainer(props, svgProps, style) {
    console.log("render container in victory-native");
    const { title, desc, className, width, height, portalZIndex, responsive, children } = props;
